...
type LoginResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Uid           []byte                 `protobuf:"bytes,1,opt,name=uid,proto3" json:"uid,omitempty"`                                       // Logged in user id
...
func (x *LoginResponse) GetUid() []byte {
	if x != nil {
		return x.Uid
	}
	return nil
...
var file_authsvc_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x08, 0x6a, 0x77, 0x74, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x23, 0x0a,
	...
	0x73, 0x68, 0x61, 0x70, 0x65, 0x75, 0x70, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x3b,
	0x61, 0x75, 0x74, 0x68, 0x73, 0x76, 0x63, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
